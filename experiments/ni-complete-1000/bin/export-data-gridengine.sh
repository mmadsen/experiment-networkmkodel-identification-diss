...
use ni-complete-1000_samples_raw;
...
seriationct-export-simids.py --experiment ni-complete-1000 --outputfile data/simids.txt

seriationct-simulation-export-builder.py --experiment ni-complete-1000 \
...
seriationct-assemblage-duration-export.py --experiment ni-complete-1000 \
